...
// Isso evita "números mágicos" no código e facilita mudar depois (ex: 6 → 10)
...
for (let i = 1; i <= totalDeFundos; i++) {
    ...
    // Ex: fundo_01.png, fundo_02.png, ..., fundo_06.png
...
// Guarda QUAL fundo está sendo usado no momento (tipo um índice do array)
// Ex: 0 = primeiro fundo, 1 = segundo...
let indiceFundoAtual = 0;

// Controla a posição horizontal do fundo
// Serve pra fazer o efeito de movimento (scroll lateral)
let fundoX = 0;

// Controla a transparência do fundo (usado em transições)
// 0 = invisível | 1 = totalmente visível
let opacidadeFundo = 0;

// Velocidade que o fundo se move (quanto maior, mais rápido o jogo parece)
let velocidadeFundo = 12;

// Opacidade da tela final (fade de game over / vitória)
// Vai aumentando aos poucos pra dar efeito suave
let opacidadeFim = 0;
// -------------------------------------------------------------------------
